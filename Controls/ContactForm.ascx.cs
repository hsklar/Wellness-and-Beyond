...
public partial class Controls_ContactForm : System.Web.UI.UserControl
{
  ...
  protected void SendButton_Click(object sender, EventArgs e)
  {
    if (Page.IsValid)
    {
      ...
      myMessage.From = new MailAddress("wellnessbeyond17@gmail.com", "Sender Name");
      myMessage.To.Add(new MailAddress("wellnessbeyond17@gmail.com", "Receiver Name"));
      myMessage.ReplyToList.Add(new MailAddress(EmailAddress.Text));
      
      SmtpClient mySmtpClient = new SmtpClient();
      mySmtpClient.Send(myMessage); //this is where i am getting the error when i try to send an email...?
